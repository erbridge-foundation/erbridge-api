...
use crate::{config::Config, esi::discovery::EsiMetadata, tasks::character_location_poll::LocationEvent};
...
pub struct AppState {
    ...
    /// logs in or adds a character.
    pub online_poll_tx: mpsc::Sender<Vec<i64>>,
